...
export const backlog: BacklogItem[] = [
  ...
  },
  {
    ...
    scope: [
      ...
      "FIXED (2026-08-31): ivory-on-terracotta was 3.87:1, and the primary CTA rendered it at 14px semibold — not 'large text' under WCAG 1.4.3, so it needed 4.5:1 and missed. Resolved without touching any locked token: every CTA (10 sites — Nav ×3, Hero, InsuranceExpandCard, BookingBlock, Footer ×2, AppointmentForm ×2) now uses the already-approved `terracotta-dark` (#a34f30) as its resting background, hover inverted to the lighter `terracotta`. Ivory-on-terracotta-dark measures 5.32:1, comfortably AA. Six further text-on-light instances of `text-terracotta` (real text, not icons — eyebrow labels, the FAQ tel: link, the required-field asterisk, the offer-card 'Schedule this offer' link) were the same 3.33–3.87:1 failure and got the same swap, verified 4.59–5.32:1 live",
