...
export const backlog: BacklogItem[] = [
  ...
  },
  {
    ...
    evidence:
      ...
      "2026-09-02, PR #70: AppointmentForm submit now guards against a double tap/Enter while in flight, sets aria-busy on the form and button, and announces \"Sending your request…\" via a visually-hidden live region rather than relying on the spinner alone. Left partial rather than done: no other async surface exists on the site yet for the empty-state half of this item to apply to — nothing to build until one does.",
    dependsOn: "Item 9",
