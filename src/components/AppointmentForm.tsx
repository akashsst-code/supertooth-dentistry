    ...
    <div className="rounded-2xl border border-sand bg-warm-ivory p-5 sm:p-8">
      ...
      <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-5">
        ...
        <button
          type="submit"
          disabled={submitting}
          className="tap-target inline-flex items-center justify-center gap-2 rounded-full bg-terracotta-dark px-6 py-3 text-sm font-semibold text-warm-ivory hover:bg-terracotta transition-colors disabled:opacity-70"
        >
          <CalendarIcon />
