...
- **Version control / repo:** SUPERSEDED 2026-08-22, see `supertooth-platform-pivot.md`. Git (this repo) is now the system of record for the site itself, not just docs. Version control means git branches/commits + Vercel preview deployments — a Vercel preview URL per branch is the pre-launch review gate (Section 10), replacing Webflow's staging environment.
